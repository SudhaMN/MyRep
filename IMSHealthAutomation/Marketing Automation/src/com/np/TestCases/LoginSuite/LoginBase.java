...
import com.np.TestCases.TestSuiteBase.SuiteBase;
import com.np.utility.Read_XLS;
import com.np.utility.SuiteUtility;

/**
 * This is the bases class for the suite one. Check the status of SuiteToRun flag 
 * @author SPoojary
 */
public class LoginBase extends SuiteBase{
	...
	//This function will be executed before LoginSuite's test cases to check SuiteToRun flag.
	@BeforeSuite
