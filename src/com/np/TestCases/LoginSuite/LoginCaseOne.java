 ...
 *
 */
public class LoginCaseOne extends LoginBase{
	...
	public void checkCaseToRun() throws IOException{
		...
		init();			
		//To set Login.xls file's path In FilePath Variable.
	...
	public void LoginCaseOneTest(String DataCol1,String DataCol2,String ExpectedResult){
		DataSet++;
		...
		//Verifying home page button
		if(elementPresent(homePage.userInfoButton)){
		...
		//If element is not present, Set flag Testfail=true.
		Testfail=true;	
	...
	public Object[][] LoginCaseOneData(){
		//To retrieve data from Data 1 Column,Data 2 Column,Data 3 Column and Expected Result column of LoginCaseOne data Sheet.
